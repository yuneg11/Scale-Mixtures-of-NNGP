...
b_variance = args.b_variance
activation = args.activation
alpha = args.alpha
beta = args.beta
epsilon_log_variance = -6 + args.epsilon_log_variance / 2
...
# dataset
x, y = data.get_dataset(args.dataset, "./data", y_newaxis=True)
...
print(vars(args))
print("Valid NLL for invgamma prior: [{:.8f}]".format(valid_neg_log_prob_invgamma))
print("Valid NLL for constant prior: [{:.8f}]".format(valid_neg_log_prob_constant))
print("Test NLL for invgamma prior:  [{:.8f}]".format(test_neg_log_prob_invgamma))
print("Test NLL for constant prior:  [{:.8f}]".format(test_neg_log_prob_constant))
